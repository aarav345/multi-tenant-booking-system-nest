...
export class InitialSchema1776830620848 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ce4257301de587562249d300f8" ON "customers" ("tenantId", "email") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_58af7b21050f1eb02ab44f7b59" ON "bookings" ("tenantId", "scheduledAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_7d0eb3e46f5612788d6a02f546" ON "bookings" ("tenantId", "status") `);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD CONSTRAINT "FK_2b285bda3e1b07b6dc1386af33b" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bookings" DROP CONSTRAINT "FK_2b285bda3e1b07b6dc1386af33b"`);
        await queryRunner.query(`ALTER TABLE "customers" DROP CONSTRAINT "FK_37c1a605468d156e6a8f78f1dc5"`);
        await queryRunner.query(`DROP TABLE "tenants"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7d0eb3e46f5612788d6a02f546"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_58af7b21050f1eb02ab44f7b59"`);
